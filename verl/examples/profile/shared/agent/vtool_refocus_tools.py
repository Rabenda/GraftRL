...
def inject_refocus_bbox_context(context: dict[str, Any], metadata: dict[str, Any]) -> None:
    """Bind bbox dicts for exec(); oracle code uses x_values_bbox / y_values_bbox by name."""
    source = metadata.get("source", "")
    x_bbox = metadata.get("x_values_bbox") or {}
    y_bbox = metadata.get("y_values_bbox") or {}
    context["x_values_bbox"] = x_bbox
    context["y_values_bbox"] = y_bbox
