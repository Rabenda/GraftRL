    ...
    def _create_tokenized_object(
        ...
        if isinstance(obj, GenerateReqInput):
            ...
            tokenized_obj = TokenizedGenerateReqInput(
                ...
                training_global_step=obj.training_global_step,
                agent_uid=obj.agent_uid,
                agent_turn=obj.agent_turn,
                agent_request_id=obj.agent_request_id,
                rollout_idx=obj.rollout_idx,
